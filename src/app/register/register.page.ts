...
import { IonContent, IonHeader, IonTitle, IonInput, IonButton } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
  imports: [IonContent, IonHeader, IonTitle, CommonModule, FormsModule, IonInput, IonButton]
})
